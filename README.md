...
**Godot 4.6** · **当前版本 v1.0.107** · **Windows / macOS / Web / Android** · **横屏 1600x900 基准布局**
...
铃仙的幻视弹以空心轮廓显示且不判伤，恢复实弹时先预警；红眼格暂时扰乱植物攻速与瞄准。月门倒计时 4 秒后召唤月兔，可被攻击或抢先种植关闭。治愈葫芦固定加入传送带，在 3×3 内抵抗狂气干扰、月食射程与阳光减益，并减轻原创月光冲击。新增月兔斥候、月兔卫兵，帝与铃仙各使用用户提供的 24 帧透明素材；其余东方人物素材保持。同期修正 11 个同角色道中的生命、击破门槛、小怪与波次冻结逻辑，以及战斗符名横幅遮挡卡槽的问题。
