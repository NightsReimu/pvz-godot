...
static func zombie_lines(kind: String) -> Array:
	match kind:
		...
		"patchouli_boss":
			return ["帕秋莉会固定盘旋在图书馆右侧，以火、水、风、金与大范围爆裂魔法轮番压场。", "她现在更依靠符卡轮转和阶段召援压住节奏，不再靠过高频率反复清场。"]
		"sakuya_boss":
			return ["十六夜咲夜会在空中悬停换行，用飞刀、时停、传送和召援把战场切成银色弹幕。", "时停会短暂打乱阵型但留有反应窗口，她既会作为 1-21 的终幕 Boss，也会在 1-22 半程拦住推进。"]
		"remilia_boss":
			return ["蕾米莉亚会在猩红长夜里持续压低全场植物血线，并以红魔枪雨、命运压场和蝙蝠群轮番施法。", "她的吸血是稳定压迫而不是瞬间清场，需要靠治疗、坚果和爆发窗口对抗。"]
		"letty_boss":
			return ["蕾蒂是冬之妖怪，会在雪夜右侧盘旋，用寒气、花枯与白色波纹弹幕持续拖慢整片花坛。", "她的临时冻结格不会要求花盆，但会降低植物节奏；终幕雪暴会配合召援压迫多路阵型。"]
		"chen_boss":
			return ["橙是守护迷途家的猫又式神，会在屋前雪夜中高速换行，用火环、式神夹击和奇门方位冲刺切开阵型。", "她的威胁来自连续压迫和分身弹幕，不是瞬间秒杀；看清冲刺路径后用坚果、治疗和爆发窗口反打。"]
		"alice_doll_zombie":
			return ["爱丽丝人偶是爱丽丝召唤出的 Boss 专属敌人，不会出现在主线事件表。", "人偶体型小但推进稳定，常和牵线弹幕、墓碑升起一起扰乱防线。"]
		"alice_boss":
			return ["爱丽丝会在魔法森林右侧盘旋，用七色魔法、上海与蓬莱人偶队列、牵线夹击和森林魔法阵轮番压场。", "她还能让坟墓从地下钻出，终幕会铺开 Return Inanimateness 风格的人偶阵；坟墓吞噬者和魔术花在这关很关键。"]
		"lily_white_boss":
			return ["莉莉霍瓦特会在云海半程带来报春弹幕，用春风、花瓣和白色妖精弹幕扰乱云朵防线。", "她的技能会配合飘动云海制造压力，但不会像终幕 Boss 那样持续压场。"]
		"prismriver_boss":
			return ["骚灵三姐妹会在云海右侧五列内前后换位，小提琴、号与键盘交替奏出音乐弹幕。", "合奏符卡会用音波、棱镜和幽灵轮舞压迫多路阵型；她们不会进家，威胁来自三姐妹的节奏与合奏。"]
		"youmu_boss":
			return ["魂魄妖梦通常守在战场右侧，用双剑剑气、现世斩和六道剑阵切开阵型。", "她偶尔会瞬步到第一列发动高速斩击；怨灵是可被攻击的实体，命中植物后才会魅惑并消散。"]
		"youmu_wraith":
		...
		"yuyuko_boss":
			return ["西行寺幽幽子会在西行妖樱庭以樱花、死蝶、亡灵与墓碑持续压场。", "她首次被击倒后会让亡灵从墓碑中涌出，樱花汇聚成西行妖并复活一次，复活后符卡节奏更强。"]
		"ran_boss":
			return ["八云蓝是八云紫的九尾狐式神，会用十二神将、狐狗狸契约、妖怪激光与前鬼后鬼式神阵压迫多路。", "蓝被击败后不会直接结束关卡，冥界与现世的境界会裂开，八云紫随后从隙间中出现。"]
		"yukari_boss":
			return ["八云紫是操纵境界的隙间妖怪，会把弹幕、植物和尸潮从成对隙间之间重新布置。", "她的符卡围绕光暗境界、二重黑死蝶、客观结界、深弹幕结界与 Necrofantasia 展开，预警后才结算高威胁攻击。"]
		"flandre_boss":
			return ["芙兰朵露会固定盘旋在血月玩具屋顶右侧，用禁忌玩具、分身弹幕、晶刺和高热斩击轮番压场。", "她保留完整符卡循环和最强终幕压力，但召援与毁灭技能之间会留出更清晰的处理窗口。"]
		"ninja":
