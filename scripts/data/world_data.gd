...
const WORLDS: Array = [
	...
	},
	{
		...
		"description": "霓虹街区、广场砖面、地铁轨道与下水道井盖共同组成新的战场。后半段会被暴风雪席卷，寒潮会覆盖整片城市战场，并在 6-19 由霓虹尸王把主线非 Boss 僵尸混编进城市终章。",
	...
	},
	{
		"key": "volcano",
		"title": "火山世界",
		"subtitle": "Adventure 7-1 ~ 7-20",
		"description": "火山坡面与岩浆火口构成二十关主线。后半程加入地热蓄能、蒸汽冷却、晶甲回收和七种火山僵尸；每关奖励植物，最终在 7-20 迎战熔岩尸王。",
